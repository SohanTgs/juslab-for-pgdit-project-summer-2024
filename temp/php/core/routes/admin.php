...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function(){
        ...
        Route::get('all/knowledge-base', 'allKnowledgeBase')->name('knowledge.base.all');
        Route::post('add/knowledge-base', 'addKnowledgeBase')->name('knowledge.base.add');
        Route::post('delete/knowledge-base/{fileName}', 'deleteKnowledgeBase')->name('knowledge.base.delete');

        Route::get('all/dataset', 'allDataset')->name('dataset.all');
        Route::get('edit/dataset/{fileName}', 'editDataset')->name('dataset.edit');
        Route::post('update/dataset/{fileName}', 'updateDataset')->name('dataset.update');
